var store = [{
        ...
        "excerpt":"준비하기 올바른 개발 학습법 알기 문과생 사고 방식 버리기 사고방식의 배경 🤓 문과생 엔지니어 1 논술에 가까운 교육 문제의 답이 정해진 경우가 많음 2 정해진 답❌ 답이 없더라도 단계별 과정 중요 3 문제의 해결책이 두루뭉실 원인과 해결책 명확 문제 해결 방식 🤓 문과생 엔지니어 1 문제를 하나의 큰 덩어리로 봄...","categories": ["Job"],
        "tags": ["Inflearn","Job"],
